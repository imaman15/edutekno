...
<head>
  ...
  <!-- Custom Theme files -->
  <link href="<?php echo base_url ('assets/home/css/style2.css')?>" rel="stylesheet" type="text/css" media="all"/>
  <!-- for-mobile-apps -->
...
<div class="wthree-dot">
  <h1 style="color: white;font-size: 40px;">EDUTEKNO</h1>
  <h4 style="color: white;font-size: 20px;text-align: center;">UNTUK PELAJAR</h4>
  <div class="profile">
    <div class="wrap">
      ...
      <?php
            $kode = $this->mhs_model->maxuser()->row();
            $kd = $kode->maxUser;
          ...
          <form action="<?php echo base_url(); ?>login/insert" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="status" value="Pelajar">
            <input type="text" name="no_induk" placeholder="No Induk (ex : NIP,NID,NIM,NIK,NIS)" required="" maxlength="10">
    ...
    <input type="submit" name="submit" value="Daftar">
      ...
      <div class="wthree_footer_copy">
        <p>© 2018 EDUTEKNO. All rights reserved </a></p>
      </div>
    </div>
  </div>
</div>
