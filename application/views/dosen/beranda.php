<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="box box-success">
          <?php echo $this->session->flashdata('info'); ?>
                ...
                ?>
          <form action="dosen/cat_insert" method="post" enctype="multipart/form-data">
      ...
      <!-- /.box utama -->
      <div class="box box-success" style="padding-left: 6px; padding-right: 6px;: ">
        <!-- /.box utama -->
        ...
        <div class="box-success box-body">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <span class="username"><a href="<?php echo base_url() ?>dosen/lihat_profil/<?php echo $kd_profil; ?>"><?php echo $v->nama_user; ?></a> <i class="fa fa-chevron-circle-right"></i> <a href="<?php echo base_url()?>dosen/kelas/<?php echo $kd_enc2; ?>"><?php echo "  ".$v->nama_kelas."  ".$v->jurusan; ?></a></span>
    ...
    <div class="col-lg-3">
      <div class="box box-widget ">
       ...
       <div class="small-box bg-blue">
        ...
        <a href="<?php echo base_url()?>dosen/file_uploads/<?php echo $kd_usr?>" class="small-box-footer">
