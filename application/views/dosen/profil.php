      ...
      <section class="content">
        ...
        <div class="box box-success">
          ...
          <div class="box box-widget widget-user ">
            ...
            <div class="widget-user-header bg-green-active headprof hp0">
          ...
          <div class="box box-success">
            ...
            <div class="col-md-7">
             ...
             ?>
             <a href="edit/<?php echo $kd_enc ?>"><button class="btn btn-success btn-edit">Edit Profil</button></a>
           </div>
                <!-- /.box-body -->
      ...
      <ul class="products-list product-list-in-box">
        ...
        <li class="item">
          ...
          <div class="product-info">
            <span class="username"><a href='<?php echo base_url() ?>dosen/lihat_profil/<?php echo $kd_enc; ?>'><?php echo $c->nama_user; ?>  </a><i class="fa fa-chevron-circle-right"></i><a href="<?php echo base_url() ?>dosen/kelas/<?php echo $kd_enc2; ?>"><?php echo "  ".$c->nama_kelas."  ".$c->jurusan; ?> </a></span><br>
