<!-- Content Header (Page header) -->
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Catatan Saya</li>
        </ol>
      </section>
        ...
        <div class="box box-primary">
          <div class="box-body">
            <div class="box-header with-border">
              <h3 class="box-title">Semua Catatan </h3>
              <?php foreach($tampil_data->result() as $v) : ?>
            </div>
            <?php
            $tgl = $v->tgl_post;
              ...
              <div class="box box-widget">
                <div class="box-header with-border">
                  <div class="user-block">
                    ...
                    <span class="username"><a href='<?php echo base_url() ?>mhs_con/lihat_profil/<?php echo $v->kd_user; ?>'><?php echo $v->nama_user; ?>  </a><i class="fa fa-chevron-circle-right"></i>
                      <a href="<?php echo base_url() ?>mhs_con/tampil_kelas/<?php echo $v->kd_kelas; ?>"><?php echo "  ".$v->nama_kelas."  ".$v->jurusan; ?></a></span>
