      ...
      <ul class="products-list product-list-in-box">
        ...
        <li class="item">
          ...
          <div class="product-info">
            <span class="username"><a href='<?php echo base_url() ?>mhs_con/lihat_profil/<?php echo $kd_enc; ?>'><?php echo $c->nama_user; ?>  </a><i class="fa fa-chevron-circle-right"></i>
            <a href="<?php echo base_url() ?>mhs_con/tampil_kelas/<?php echo $kd_enc2; ?>"><?php echo "  ".$c->nama_kelas."  ".$c->jurusan; ?> </a></span><br>
